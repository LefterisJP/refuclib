...
with his team for response to governors and mayors seeking federal assistance."));
    EXPECT_MSG(131,rfString_Length(&s1),"String had unexpected length");

    //expect 123: This string's length
    EXPECT(true,rfString_Init(&s2,"【北京＝峯村健司】中国共産党の第１７期中央委員会第７回全体会議（７中全会）が１日、北京市内で開会した模様だ。８日からの第１８回党大会\
の準備作業をする。党指導部の世代交代が進むとみられる５年に１度の党大会前後の一連の政治的な行事が本格的に始まった。"));
