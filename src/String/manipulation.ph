...
i_INLINE_DECL bool rf_stringgen_prepend(void* thisstr, const char* other,
...
i_INLINE_DECL bool rf_stringxgen_append(RFstringx* s,
                                       const char* other,
                                       unsigned int bytes_to_copy)
{
    ...
    RF_STRINGX_REALLOC(s,
                       ...
                       false);
    rf_stringgen_append(s, other, bytes_to_copy);
    return true;
}
                                 ...
                                 const void* sstr, const char options)
{
    ...
    RFstringx temp;//just a temporary string for finding the occurences
